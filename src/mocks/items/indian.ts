...
export const INDIAN_ITEMS: MenuItem[] = [
  ...
  makeItem({
    ...
    options: [OPTIONS.spiceChoice], dietary: ["veg"], veg: true, spice: 1,
    collectionSlugs: ["indian-soul"],
  }),
  makeItem({
    ...
    options: [OPTIONS.spiceChoice], dietary: ["halal", "chefs-special"], spice: 2,
    collectionSlugs: ["indian-soul"],
  }),
  // Tandoor
  makeItem({
    ...
    options: [OPTIONS.spiceChoice], dietary: ["halal", "bestseller"], spice: 2,
    collectionSlugs: ["indian-soul"],
  }),
  makeItem({
    ...
    options: [OPTIONS.spiceChoice], dietary: ["halal"], spice: 2,
  }),
  makeItem({
  ...
  makeItem({
    ...
    options: [OPTIONS.spiceChoice], dietary: ["halal", "bestseller", "chefs-special"], spice: 2,
    collectionSlugs: ["indian-soul"],
  }),
  makeItem({
  ...
  makeItem({
    ...
    dietary: ["veg", "seasonal"], veg: true, collectionSlugs: ["seasonal"],
  }),
];
